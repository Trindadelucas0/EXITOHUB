      ...
      items: [
        {
          id: 'integracao',
          label: 'Integração',
          href: '/hub/modulo/integracao',
          require: 'admin',
          status: 'soon',
          icon: 'plug',
          currentKey: 'modulo-integracao',
          description: 'Integrações internas do escritório.',
        },
        {
          id: 'pops',
          label: 'POPs',
          href: '/hub/modulo/pops',
          require: 'admin',
          status: 'soon',
          icon: 'clipboard',
          currentKey: 'modulo-pops',
          description: 'Procedimentos operacionais padrão.',
        },
        {
          id: 'informativos',
          label: 'Informativos',
          href: '/hub/modulo/informativos',
          require: 'admin',
          status: 'soon',
          icon: 'megaphone',
          currentKey: 'modulo-informativos',
          description: 'Comunicados e informativos internos.',
        },
        {
          id: 'organograma',
          label: 'Organograma',
          href: '/hub/modulo/organograma',
          require: 'admin',
          status: 'soon',
          icon: 'network',
          currentKey: 'modulo-organograma',
