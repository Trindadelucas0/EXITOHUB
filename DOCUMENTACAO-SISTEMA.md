...
> Versão: 1.3.3 — Unica: conferência de Abreviação sem confundir Desc. Abrev. ICMS com Aliq. DF.
...
5. Escritório NCM: em Empresas, **Entrar** na Unica → **Base fiscal** para ver CEST, **Abrev.** e alíquotas DF/GO/MG. Importe o CSV em **Planilhas**. No **Panorama**, o card **Corretos** são os itens cuja Abreviação bate com a base (`004` = `4`). **Divergências** mostra só o que não bateu (Abreviação diferente ou NCM fora da base).
