...
export function CstMatrix({
  ...
  if (layout === "stacked") {
    ...
    return (
      <dl className="overflow-hidden rounded-lg border border-line bg-white shadow-panel">
  ...
  return (
    <div className="overflow-auto rounded-lg border border-line bg-white shadow-panel">
